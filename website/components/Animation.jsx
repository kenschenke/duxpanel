    ...
    100% {
        ...
        return (
            <div style={{paddingBottom:25}}>
                ...
                <div>
                    <button type="button" className="btn btn-primary mr-3" onClick={this.toggleTopPanel}>Sliding From Top</button>
                    <button type="button" className="btn btn-primary mr-3" onClick={this.toggleRightPanel}>Sliding From Right</button>
                    <button type="button" className="btn btn-primary mr-3" onClick={this.toggleBottomPanel}>Sliding From Bottom</button>
                    <button type="button" className="btn btn-primary mr-3" onClick={this.toggleLeftPanel}>Sliding From Left</button>
                </div>
